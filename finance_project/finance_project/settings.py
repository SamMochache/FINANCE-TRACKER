...
AUTHENTICATION_BACKENDS = (
    ...
    'allauth.account.auth_backends.AuthenticationBackend',  # For allauth (including social login)
)
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR / 'finance/templates',  # Add this line for your app's templates
            BASE_DIR / 'templates',
        ],
        'APP_DIRS': True,
        'OPTIONS': {
